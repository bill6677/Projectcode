...
<link href="<%=request.getContextPath()%>/src/menu/sidemenu.css"
	rel="stylesheet" />
<script src="<%=request.getContextPath()%>/data/menudata.js"></script>
...
<body style="background-color: #000">
	<div class="header">
		<div class="logo">
			<img src="<%=request.getContextPath()%>/photo/43.jpg" /><span><%=session.getAttribute("sysname") %><a href="<%=request.getContextPath() %>/log/loginout">&nbsp;&nbsp;<span style="font-size: 10px;color: white;"> log out</span></a></span>
		</div>
